...
<head>
    <meta charset="UTF-8">
    <title><?php echo f('page.title', 'Dapur Xinix') ?> <?php echo f('controller.name') ? '| '.f('controller.name') : '' ?></title>

    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <meta name="apple-mobile-web-app-capable" content="yes" />
    <meta name="apple-mobile-web-app-status-bar-style" content="black" />

    <script type="text/javascript" src="<?php echo \Bono\Helper\URL::base('vendor/jquery/dist/jquery.min.js') ?>"></script>
    <script type="text/javascript" src="<?php echo \Bono\Helper\URL::base('vendor/jquery-ui/jquery-ui.min.js') ?>"></script>

    <link rel="stylesheet" type="text/css" href="<?php echo \Bono\Helper\URL::base('vendor/jquery-ui/themes/base/jquery-ui.min.css') ?>">
    ...
    <style>
        ...
        header { background-color: #f1f1f1; border-bottom: 1px solid #666; border-color: #e5e5e5; height: 59px; position: relative; }

        header h1 { text-align: center; font-size: 1.5rem; margin: 0; color: #444; }

        header .home-icon { position: absolute; top: 10px; left: 10px; z-index: 2; }

        main { padding: .8rem; width: 100%; margin: 0 auto; flex: 1; box-sizing: border-box;}
        ...
        .navMenu { position: relative; text-align: center; height: 100%; }
        .navMenu ul { padding: 0; display: table; margin: 0 auto; list-style: none; padding: 12px 0px; }
        .navMenu ul li { display: inline-block; padding: 0 30px; vertical-align: middle; }
