...
class Currency {
	...
	public static function terbilang($i){
		...
		elseif ($i < 1000000000000) return Currency::terbilang($i / 1000000000) . " milyar" . Currency::terbilang($i % 1000000); 
	}
	...
	public static function terbilang_en($i){
		...
		elseif ($i < 100) return  $puluhan[round($i/10) * 10] . Currency::terbilang_en($i % 10);
		...
		elseif ($i < 1000000000000) return Currency::terbilang_en($i / 1000000000) . " billion" . Currency::terbilang_en($i % 1000000); 
	}
